    ...
    */
    ...
    var messages = {
        _default: function _default(field) {
            return "El campo " + field + " no es v\xE1lido.";
        },
        after: function after(field, _ref) {
            var target = _ref[0],
                inclusion = _ref[1];
            return "El campo " + field + " debe ser posterior " + (inclusion ? 'o igual ' : '') + "a " + target + ".";
        },
        alpha: function alpha(field) {
            return "El campo " + field + " solo debe contener letras.";
        },
        alpha_dash: function alpha_dash(field) {
            return "El campo " + field + " solo debe contener letras, n\xFAmeros y guiones.";
        },
        alpha_num: function alpha_num(field) {
            return "El campo " + field + " solo debe contener letras y n\xFAmeros.";
        },
        alpha_spaces: function alpha_spaces(field) {
            return "El campo " + field + " solo debe contener letras y espacios.";
        },
        before: function before(field, _ref2) {
            var target = _ref2[0],
                inclusion = _ref2[1];
            return "El campo " + field + " debe ser anterior " + (inclusion ? 'o igual ' : '') + "a " + target + ".";
        },
        between: function between(field, _ref3) {
            var min = _ref3[0],
                max = _ref3[1];
        ...
        credit_card: function credit_card(field) {
            return "El campo " + field + " es inv\xE1lido.";
        },
        date_between: function date_between(field, _ref4) {
            var min = _ref4[0],
                max = _ref4[1];
            return "El campo " + field + " debe estar entre " + min + " y " + max + ".";
        },
        date_format: function date_format(field, _ref5) {
            var format = _ref5[0];
            return "El campo " + field + " debe tener un formato " + format + ".";
        },
        decimal: function decimal(field, _temp) {
            var _ref6 = _temp === void 0 ? [] : _temp,
                _ref6$ = _ref6[0],
                decimals = _ref6$ === void 0 ? '*' : _ref6$;

            return "El campo " + field + " debe ser num\xE9rico y contener" + (decimals === '*' ? '' : ' ' + decimals) + " puntos decimales.";
        },
        digits: function digits(field, _ref7) {
            var length = _ref7[0];
            return "El campo " + field + " debe ser num\xE9rico y contener exactamente " + length + " d\xEDgitos.";
        },
        dimensions: function dimensions(field, _ref8) {
            var width = _ref8[0],
                height = _ref8[1];
            return "El campo " + field + " debe ser de " + width + " p\xEDxeles por " + height + " p\xEDxeles.";
        },
        email: function email(field) {
            return "El campo " + field + " debe ser un correo electr\xF3nico v\xE1lido.";
        },
        excluded: function excluded(field) {
            return "El campo " + field + " debe ser un valor v\xE1lido.";
        },
        ext: function ext(field) {
            return "El campo " + field + " debe ser un archivo v\xE1lido.";
        },
        ...
        integer: function integer(field) {
            return "El campo " + field + " debe ser un entero.";
        },
        ip: function ip(field) {
            return "El campo " + field + " debe ser una direcci\xF3n ip v\xE1lida.";
        },
        length: function length(field, _ref9) {
            var _length = _ref9[0],
                max = _ref9[1];

            if (max) {
                return "El largo del campo " + field + " debe estar entre " + _length + " y " + max + ".";
            }

            return "El largo del campo " + field + " debe ser " + _length + ".";
        },
        max: function max(field, _ref10) {
            var length = _ref10[0];
            return "El campo " + field + " no debe ser mayor a " + length + " caracteres.";
        },
        max_value: function max_value(field, _ref11) {
            var max = _ref11[0];
            return "El campo " + field + " debe de ser " + max + " o menor.";
        },
        mimes: function mimes(field) {
            return "El campo " + field + " debe ser un tipo de archivo v\xE1lido.";
        },
        min: function min(field, _ref12) {
            var length = _ref12[0];
            return "El campo " + field + " debe tener al menos " + length + " caracteres.";
        },
        min_value: function min_value(field, _ref13) {
            var min = _ref13[0];
            return "El campo " + field + " debe ser " + min + " o superior.";
        },
        numeric: function numeric(field) {
            return "El campo " + field + " debe contener solo caracteres num\xE9ricos.";
        },
        regex: function regex(field) {
            return "El formato del campo " + field + " no es v\xE1lido.";
        },
        ...
        size: function size(field, _ref14) {
            var _size = _ref14[0];
            return "El campo " + field + " debe ser menor a " + formatFileSize(_size) + ".";
        },
        url: function url(field) {
            return "El campo " + field + " no es una URL v\xE1lida.";
        }
    };
